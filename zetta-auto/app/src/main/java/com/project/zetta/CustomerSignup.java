    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CustomerSignup.this, CustomerLogin_page.class);
    ...
    private boolean singUP()
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child("Users").child(phn).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(CustomerSignup.this, "Network Error: Please try again after some time...", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
                                }
                            });
                ...
                {
                    loadingBar.dismiss();
                    Toast.makeText(CustomerSignup.this, "This " + phn + " already exists.", Toast.LENGTH_SHORT).show();
                    Toast.makeText(CustomerSignup.this, "Please try again using another phone number.", Toast.LENGTH_SHORT).show();
                }
            }
