...
public class VendorLogin_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signuplink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VendorLogin_page.this, VendorSignup.class);
        ...
        forgetPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VendorLogin_page.this, ForgetPasswordActivity.class);
                ...
                if (dataSnapshot.child(parentDbName).child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        if (usersData.getPassword().equals(password))
                        {
                            ...
                            {
                                Toast.makeText(VendorLogin_page.this, "logged in Successfully...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();

                                Intent intent = new Intent(VendorLogin_page.this, VendorHomeActivity.class);
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(VendorLogin_page.this, "Password is incorrect.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                else
                {
                    Toast.makeText(VendorLogin_page.this, "Account with this " + phone + " number do not exists.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
