...
public class VendorSignup extends AppCompatActivity {
    ...
    private EditText username, mobile, password, re_password, register_company_number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VendorSignup.this, VendorLogin_page.class);
        ...
        register_company_number = (EditText) findViewById(R.id.register_company_number);
    ...
    {
        final String nam, phn, pass, repass, company;
        ...
        company = register_company_number.getText().toString();
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            {
                if (!(dataSnapshot.child("Vendors").child(phn).exists()))
                {
                    HashMap<String, Object> userdataMap = new HashMap<>();
                    userdataMap.put("phone", phn);
                    userdataMap.put("password", pass);
                    userdataMap.put("name", nam);
                    userdataMap.put("company", company);

                    RootRef.child("Vendors").child(phn).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(VendorSignup.this, "Congratulations, your account has been created.", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                        Intent intent = new Intent(VendorSignup.this, VendorLogin_page.class);
                                        startActivity(intent);
                                        finish();
                                    ...
                                    {
                                        Toast.makeText(VendorSignup.this, "Network Error: Please try again after some time...", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
                                }
                            });
                ...
                {
                    loadingBar.dismiss();
                    Toast.makeText(VendorSignup.this, "This " + phn + " already exists.", Toast.LENGTH_SHORT).show();
                    Toast.makeText(VendorSignup.this, "Please try again using another phone number.", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    {
        if(register_company_number.getText().toString().isEmpty())
        {
            Toast.makeText(getApplication(), "Provide company number", Toast.LENGTH_SHORT).show();
            return true;
        }
