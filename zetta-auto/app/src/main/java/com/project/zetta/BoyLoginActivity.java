...
public class BoyLoginActivity extends AppCompatActivity {
    ...
    private String parentDbName = "boys";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boy_login);
        ...
        signuplink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BoyLoginActivity.this, BoySignupActivity.class);
        ...
        forgetPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BoyLoginActivity.this, ForgetPasswordActivity.class);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.child(parentDbName).child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        ...
                        {
                            if (parentDbName.equals("boys"))
                            {
                                Toast.makeText(BoyLoginActivity.this, "logged in Successfully...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();

                                Intent intent = new Intent(BoyLoginActivity.this, BoyHomeActivity.class);
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(BoyLoginActivity.this, "Password is incorrect.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                else
                {
                    Toast.makeText(BoyLoginActivity.this, "Account with this " + phone + " number do not exists.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
