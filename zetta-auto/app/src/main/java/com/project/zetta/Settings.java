...
public class Settings extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        spinnerGender.setOnItemSelectedListener(Settings.this);
        ...
        closeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                startActivity(new Intent(Settings.this, CustomerHomeActivity.class));
                finish();
